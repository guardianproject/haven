...
public class PreferenceManager {
	...
	private static final String AMBIENT_LIGHT_ACTIVE="ambient_light_active";
    ...
    public void activateAmbientLight(boolean active) {
        prefsEditor.putBoolean(AMBIENT_LIGHT_ACTIVE, active);
        prefsEditor.commit();
    }

    public boolean getAmbientLightActivation() {
