...
public class SettingsFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener, TimePickerDialog.OnTimeSetListener {
    ...
    protected void save() {
        ...
        SwitchPreferenceCompat ambientlightenabled = (SwitchPreferenceCompat)findPreference("ambient_light_active");
        boolean ischecked = ambientlightenabled.isChecked();

        preferences.activateAmbientLight(ambientlightenabled.isChecked());
